...
def get_all_data(scheme:str='UPS', investment_option:str = 'Auto_LC50', 
                ...
                initial_inflation_rate:float = 7.0, final_inflation_rate:float = 4.0, 
...
def main_function(**kwargs):
    ...
    # 3. get_final_corpus() -> contribution.py
    ...
    all_data['monthly_salary_detailed'] = monthly_salary_detailed
        ...
        # Add new received variables into kwargs, to pass them as input into nect functions
    kwargs['final_corpus_amount'] = final_corpus_amount
    kwargs['monthly_salary_detailed'] = monthly_salary_detailed
    
    # 4. get_final_amounts_all() -> pension.py
    ...
    # 5. get: npv, xirr, future_pension --> pension.py
